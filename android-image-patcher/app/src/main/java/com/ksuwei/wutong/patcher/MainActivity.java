package com.ksuwei.wutong.patcher;
...
public final class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appendLog("输出位置：内部存储/Download/WutongSU\n");
    }
    ...
    private void startPatch() {
        ...
        appendLog("\n开始修补，KMI：" + kmi + "\n");
        new Thread(() -> patchInBackground(kmi), "WutongSU-image-patch").start();
    }
    ...
    private void patchInBackground(String kmi) {
        try {
            ...
            String visiblePath = "/storage/emulated/0/Download/WutongSU/" + outputName;
            appendLog("\n修补成功\n输出路径：" + visiblePath + "\nURI：" + saved + "\n");
            runOnUiThread(() -> Toast.makeText(
                    this, "已保存到 Download/WutongSU", Toast.LENGTH_LONG).show());
    ...
    private Uri saveToDownloads(File source, String name) throws IOException {
        ...
        values.put(MediaStore.Downloads.RELATIVE_PATH, Environment.DIRECTORY_DOWNLOADS + "/WutongSU");
